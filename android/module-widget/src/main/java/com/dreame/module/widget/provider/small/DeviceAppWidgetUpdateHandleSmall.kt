...
internal class DeviceAppWidgetUpdateHandleSmall : AbstractDeviceAppWidgetUpdateHandle() {

    override fun appWidgetEnumCode(): Int = AppWidgetEnum.WIDGET_SMALL_SINGLE.code
    ...
    override suspend fun buildUpdateRemoteView(
        ...
        val layoutId = if (supportFastCmd || supportVideo) {
            R.layout.widget_device_small_multi_row
        } else {
            R.layout.widget_device_small_single_row
        }
        return RemoteViews(context.packageName, layoutId).apply {
            ...
            if (supportVideo && supportFastCmd) {
                ...
                setViewVisibility(R.id.fl_device_monitor, View.VISIBLE)
                setViewVisibility(R.id.fl_device_fast_command, View.INVISIBLE)
                setViewVisibility(R.id.fl_device_empty, View.GONE)
