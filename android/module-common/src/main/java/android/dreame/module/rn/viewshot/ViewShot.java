package android.dreame.module.rn.viewshot;
...
public class ViewShot implements UIBlock {
     ...
     */
    public static final boolean ERROR_UNABLE_TO_SNAPSHOT = false;
    /**
    ...
    public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
        ...
        if (view == null) {
            ...
            callback.invoke(ERROR_UNABLE_TO_SNAPSHOT, "No view found with reactTag: " + tag);
            return;
        }
        ...
        try {
            ...
            callback.invoke(ERROR_UNABLE_TO_SNAPSHOT, "Failed to capture view snapshot");
        }
    }
    //endregion
    ...
    private void saveToTempFileOnDevice(@NonNull final View view) throws IOException {
        ...
        callback.invoke(Boolean.TRUE, output.getAbsolutePath());
    }
    ...
    private void saveToRawFileOnDevice(@NonNull final View view) throws IOException {
        ...
        callback.invoke(Boolean.TRUE, Uri.fromFile(output).toString());
    }
    ...
    private void saveToDataUriString(@NonNull final View view) throws IOException {
        ...
        callback.invoke(Boolean.TRUE, "data:image/" + imageFormat + ";base64," + data);
    }
    ...
    private void saveToBase64String(@NonNull final View view) throws IOException {
        ...
        callback.invoke(Boolean.TRUE, data);
    }
