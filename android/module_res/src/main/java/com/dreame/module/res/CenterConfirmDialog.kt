...
class CenterConfirmDialog(context: Context) : BasePopWindowWrapper(context) {
    ...
    init {
        ...
        setContentView(R.layout.common_dialog_center_confirm)
    ...
    fun show(
        ...
        positive: String,
        negative: String? = "",
        positiveCallback: (dialog: CenterConfirmDialog) -> Unit,
        negativeCallback: ((dialog: CenterConfirmDialog) -> Unit)? = null
    ) {
