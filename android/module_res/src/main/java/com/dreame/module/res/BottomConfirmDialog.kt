...
class BottomConfirmDialog(context: Context) : BasePopWindowWrapper(context) {
    ...
    init {
        ...
        setContentView(R.layout.common_dialog_bottom_confirm)
    ...
    fun show(
        ...
        positive: String,
        negative: String? = "",
        positiveCallback: (dialog: BottomConfirmDialog) -> Unit,
        negativeCallback: ((dialog: BottomConfirmDialog) -> Unit)? = null
    ) {
