...
class ClassicIndicatorState extends State<ClassicIndicator>
  ...
  @override
  void didUpdateWidget(ClassicIndicator oldWidget) {
      ...
      icon = SizedBox(
        ...
        child: AnimatedRotationBox(
          child: GradientCircularProgressIndicator(
            stokeWidth: widget.progressIndicatorStrokeWidth ??
  ...
  Widget _buildMessage() {
    return widget.messageBuilder
        ...
        Padding(
          padding: const EdgeInsets.only(top: 4).withRTL(context),
          child: Text(
            _messageText,
            // ignore: deprecated_member_use
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if (widget.showText)
            Container(
              margin: const EdgeInsets.only(left: 8).withRTL(context),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (widget.showText)
            Container(
              margin: EdgeInsets.only(bottom: widget.spacing).withRTL(context),
              width: widget.textDimension,
              child: RotatedBox(
                quarterTurns: -1,
                child: Column(
