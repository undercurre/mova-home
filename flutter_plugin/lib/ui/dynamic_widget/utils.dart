...
import 'package:flutter_plugin/ui/dynamic_widget/drop_cap_text.dart';
...
Map<String, dynamic>? exportTextStyle(TextStyle? textStyle) {
  ...
  Map<String, dynamic> exportdMap = <String, dynamic>{
  ...
  exportdMap.removeWhere((key, value) => value == null);
  return exportdMap;
}
