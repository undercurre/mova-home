...
class CachedNetworkImageWidgetParser extends WidgetParser {
  ...
  Map<String, dynamic>? export(Widget? widget, BuildContext? buildContext) {
    ...
    return <String, dynamic>{
      ...
      'errorWidget': DynamicWidgetBuilder.export(
          realWidget.errorWidget!(buildContext!, realWidget.imageUrl, Error()),
          buildContext),
      'placeholder': DynamicWidgetBuilder.export(
          realWidget.placeholder!(buildContext, realWidget.imageUrl),
          buildContext)
    };
  }
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    double? height =
        map.containsKey('height') ? map['height']?.toDouble() : null;
    Map<String, dynamic>? errWidgetMap = map['errorWidget'];
    Widget? errorWidget = errWidgetMap == null
        ? null
        : DynamicWidgetBuilder.buildFromMap(
            errWidgetMap, buildContext, listener, dataBuilder);

    Map<String, dynamic>? placeholderMap = map['placeholder'];
    Widget? placeholder = errWidgetMap == null
        ? null
        : DynamicWidgetBuilder.buildFromMap(
            placeholderMap, buildContext, listener, dataBuilder);
