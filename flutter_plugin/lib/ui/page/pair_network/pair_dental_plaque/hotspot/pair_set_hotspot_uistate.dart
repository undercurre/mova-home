...
part 'pair_set_hotspot_uistate.freezed.dart';

@freezed
class PairSetHotspotUiState with _$PairSetHotspotUiState {
  const factory PairSetHotspotUiState({
